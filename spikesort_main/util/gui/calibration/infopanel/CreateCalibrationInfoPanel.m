...
% MAIN PANEL
    ...
    experiment_name = uicontrol('Parent', h, ...
                               'Tag', 'infopanel_experiment_name', ...
                               'Style', 'edit', ...
                               'Enable', 'inactive', ...
                               'String', "  Name: " + CBPdata.experiment_name, ...
    ...
    numchans       = uicontrol('Parent', h, ...
                               ...
                               'Style', 'edit', ...
                               'Enable', 'inactive', ...
                               'String', "Channels: " + CBPdata.raw_data.nchan, ...
    ...
    samplerate     = uicontrol('Parent', h, ...
                               ...
                               'Style', 'edit', ...
                               'Enable', 'inactive', ...
                               'String', "fs: " + round(1/CBPdata.raw_data.dt) + " Hz", ...
                               'HorizontalAlignment', 'center', ...
                               'Units', 'normalized', ...
