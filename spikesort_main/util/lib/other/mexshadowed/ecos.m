...
%
%
% Modified by Peter H. Li just to provide an error if ECOS mex is not
% compiled / found.
function varargout = ecos(varargin)
error('ECOS:no_mex', 'ECOS mex file needs to be compiled for your system and put on the Matlab path.');