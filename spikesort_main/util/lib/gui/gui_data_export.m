<<<<<<< HEAD:spikesort_main/util/lib/gui/gui_data_export.m
function submenu = gui_data_export(handle, dataname, menu_name_or_handle)
%%@Mike's note: this does not seem to be used
...
data = getappdata(fig, dataname);
assignin('base', dataname, data);
>>>>>>> 61a3b0d36e8cdf1210fb7f305aba3d99880c1cdc:spikesort_main/util/lib/gui/gui_data_export.m
