<<<<<<< HEAD:spikesort_main/util/lib/cbp/polar_1D/polar_1D_sp_cnv_mtx.m
...
waveform_total_sizes = cellnumel(Waveforms);
waveform_lens = celllength(Waveforms);

signal_total_sizes = cellnumel(input_signals);
signal_lens = celllength(input_signals);
...
for waveform_num = 1 : num_waveforms
    ...
    for signal_num = 1 : num_signals 
        ...
        xlens = celllength(info{signal_num}.grid_points);
...
for waveform_num = 1 : num_waveforms
    ...
    column_offset = column_offset + waveform_length * num_channels;    
>>>>>>> 61a3b0d36e8cdf1210fb7f305aba3d99880c1cdc:spikesort_main/util/lib/cbp/polar_1D/polar_1D_sp_cnv_mtx.m
end