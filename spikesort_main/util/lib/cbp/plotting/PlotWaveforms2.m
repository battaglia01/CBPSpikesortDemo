<<<<<<< HEAD:spikesort_main/util/lib/cbp/plotting/PlotWaveforms2.m
...
for i = 1 : length(Features)
    ...
    xlim(max(celllength(Features) ./ 2) .* [-1, 1]);
...
for i = 1 : length(Features)
    ...
    title (sprintf('%d: norm=%0.3f diff=%0.3f', ...
                   i, norm(Features{i}, 'fro'), diff));
>>>>>>> 61a3b0d36e8cdf1210fb7f305aba3d99880c1cdc:spikesort_main/util/lib/cbp/plotting/PlotWaveforms2.m
end