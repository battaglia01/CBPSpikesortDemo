<<<<<<< HEAD:spikesort_main/util/lib/cbp/plotting/PlotResidualStats.m
...
%residuals = Rnorms ./ cellnumel(data) ./ (noise_sigma ^ 2);    
...
set(gca, 'FontSize', font_size);
xlabel('residual / \sigma ');
>>>>>>> 61a3b0d36e8cdf1210fb7f305aba3d99880c1cdc:spikesort_main/util/lib/cbp/plotting/PlotResidualStats.m
ylabel('freq');