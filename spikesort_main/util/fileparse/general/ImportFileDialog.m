...
function result = ImportFileDialog
    ...
    message = {'', ...
        ...
        '', ...
        '*Simulator*', ...
        'Adjustable spike data simulator, modeled on Quiroga''s data, that can generate a ' ...
        'simulated spike recording with adjustable number of channels, embedded spike waveforms, etc.', ...
        '', ...
    ...
    harris1 = uicontrol('Parent',dialogwin,...
        'Style', 'Pushbutton', ...
        'Units', 'normalized', ...
        'Position', [1/4 0 1/4 0.075],...
        'String', 'Harris1',...
        'Callback', @(varargin) choosefile('Harris1'));

    simulated = uicontrol('Parent',dialogwin,...
        'Style', 'Pushbutton', ...
        'Units', 'normalized', ...
        'Position', [2/4 0 1/4 0.075],...
        'String', 'Simulator',...
        'Callback', @(varargin) choosefile('Simulator'));
    
    fromfile = uicontrol('Parent',dialogwin,...
        'Style', 'Pushbutton', ...
        'Units', 'normalized', ...
        'Position', [3/4 0 1/4 0.075],...
...
%     try
        switch id
            ...
            case 'Harris1'
                ...
                indx = 1;   % the index for a CBP file
            case 'Simulator'
                % This is the spike wavefrom simulator
                fprintf('Generating simulated spike data...\n');
                filename = '';
                indx = -1;  % Special code just for simulator
            otherwise
                % Open file dialog
        ...
        if indx == -1
            % They chose the simulator
            CreateSimulatedSpikeRecording;
            InitializeSession("Simulated");
        else
            % If the index is -1, this just means they chose
            % the simulator.
